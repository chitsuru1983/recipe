...
def main():
    ...
    with link_col1:
        st.info("📺 [動画レッスン](https://osakafoodstyle.stores.jp/)")

    with link_col2:
        st.info("📢 [最新ニュース](https://www.osakafoodstyle.com/news/)")

    with link_col3:
        st.info("📸 [Instagram](https://www.instagram.com/osakafoodstyle/)")
    ...
    if "pickup_recipe" not in st.session_state:
        ...
        st.session_state.pickup_recipe = (
            seasonal_df.sample(1).iloc[0]
    ...
    if len(filtered_df) == 0:
        ...
        for idx, (i, row) in enumerate(
            ...
            with cols[idx % 2]:
                ...
                is_fav = (
                    title in st.session_state.favorites
                )
